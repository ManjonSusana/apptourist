...
class _RestaurantesPageState extends State<RestaurantesPage> {
  ...
  try {
    final listaDesdeApi =
        await BackendApiService.instance.obtenerRestaurantes();
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: CustomSearchBar(onSearch: filtrarRestaurantes, usuario: widget.usuario),
                        ),
                      ],
                    ),
                    ...
                    _listaHorizontal(
                      restaurantesFiltrados.where((r) => r["precio"] == "alto").toList(),
                    ),
                    ...
                    _listaHorizontal(
                      restaurantesFiltrados.where((r) => r["precio"] == "bajo").toList(),
                    ),
