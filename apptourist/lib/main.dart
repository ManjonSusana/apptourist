    ...
    return MaterialApp(
      ...
      routes: {
        ...
        "/detalleBar": (context) {
          ...
          return DetalleBarPage(bar: bar, usuario: usuario);
        },
        ...
        "/detalleLugar": (context) {
          ...
          return DetalleLugarPage(lugar: lugar, usuario: usuario);
        },
        ...
        "/detalleFecha": (context) {
          ...
          final hito =
              ModalRoute.of(context)!.settings.arguments as HitoDestacado;
        ...
        "/detalleEvento": (context) {
          ...
          return DetalleEventoPage(evento: evento, hitoPadre: hitoPadre);
        },
      },
    );
  }
