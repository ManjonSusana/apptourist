...
class DetalleLugarPage extends StatefulWidget {
  ...
  const DetalleLugarPage({super.key, required this.lugar, this.usuario});
...
class _DetalleLugarPageState extends State<DetalleLugarPage> {
  ...
  Future<void> cargarComentarios() async {
    final lista = await DBService.instance.obtenerComentariosDeLugar(
      widget.lugar["id"],
    );
